...
<body>
    ...
    <script>
        ...
        $.ajax({
            type: "GET",
            url: ` http://127.0.0.1:8000/api/usuarios/${id2}`,
            success: function(response) {
                $("#nombreU").val(response.Nombre);
                $("#apellidosU").val(response.Apellidos);
                $("#identiU").val(response.Identificacion);
                        ...
                        <div class="row" style="text-align: center;">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" disabled class="form-control" id="nombreU" name="nombreU" placeholder="Nombre" value="">
                                    <input type="text" disabled class="form-control" id="apellidosU" name="apellidosU" placeholder="Apellidos" value="">
                                </div>
                            </div>
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"  class="form-control" id="identiU" name="identiU" disabled placeholder="Identificación" value="${usuario}">
                                </div>
                            </div>
